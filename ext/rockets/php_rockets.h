...
#define PHP_ROCKETS_VERSION "0.1.0"
...
/* Always refer to the globals in your function as ROCKETS_G(variable).
   You are encouraged to rename these macros something shorter, see
   examples in any other php module directory.
*/
#define ROCKETS_G(v) ZEND_MODULE_GLOBALS_ACCESSOR(rockets, v)

#if defined(ZTS) && defined(COMPILE_DL_ROCKETS)
